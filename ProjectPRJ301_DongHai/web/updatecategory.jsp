                        ...
                        <div id="genre-data" class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label custom-label-ip" for="inlineRadio5">Update</label>
                                </div>
                                <div class="form-check form-check-inline">
                                ...
                                <c:set value="${requestScope.cate}" var="ca"/>  
                                <form action="updatecategory" method="post">
                                    <div class="Add-Nwrapper row">
                                        <div id="add-New" class="col-md-3 form-row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input readonly type="text" class="form-control custom-label-ip"
                                    ...
                                    <button type="submit" class="col-md-3 btn btn-outline-primary custom-btn-addN" onclick="this.form.submit()">Update</button>
                                </form>
