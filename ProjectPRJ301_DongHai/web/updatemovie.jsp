                ...
                <div class="main-cotainer">
                    <div class="main-header">
                        ...
                        <ul>
                            ...
                            <li class="breadcrumb-item active"><a href="#">Update movies</a></li>
                        </ul>
                    </div>
                    <div class="main-form">
                        <c:set value="${requestScope.movie}" var="m"/>
                        <form action="updatemovie" method="post" enctype="multipart/form-data" >
                            <div class="form-group row">
                                <label for="inputID" class="col-sm-2 col-form-label custom-label-ip">Movie ID</label>
                                <div class="col-sm-10">
                                    <input readonly type="text" class="form-control custom-label-ip" id="inputID"
                                           placeholder="Name..." name="id" value="${m.id}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control custom-label-ip" id="inputName3"
                                           placeholder="Name..." name="name" value="${m.name}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control custom-label-ip" id="inputRealseYear3"
                                           placeholder="Realse Year..." name="RealseYear" value="${m.release}" >
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class="form-control custom-label-ip" id="banner"
                                           placeholder="Banner..." name="banner" value="${m.image}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control custom-label-ip" id="inputSrc3"
                                           placeholder="Src..." name="Src" value="${m.linkmovie}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control custom-label-ip" id="inputDescription3"
                                           placeholder="Description..." name="Description" value="${m.describe}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control custom-label-ip" id="inputActor"
                                           placeholder="Description..." name="Actor" value="${m.actor}">
                                </div>
                            </div><!-- comment -->
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control custom-label-ip" id="inputDirector"
                                           placeholder="Description..." name="Director" value="${m.director}"> 
                                </div>
                            </div>
                            <div class="form-group row">
